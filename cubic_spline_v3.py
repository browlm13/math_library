...
__filename__ = "cubic_spline_v2.py"
...
if __name__ == '__main__':
	...
	interpolation_ys2 = []
	for x in t:
		interpolated_y = cubic_spline_evaluate(t,y,z2,x)
		interpolation_ys2.append(interpolated_y)
	...
	yhats2 = []
	for x in xs:
		yhat = cubic_spline_evaluate(t,y,z2,x)
		yhats2.append(yhat)
